...
const HistoryView: React.FC<Props> = ({ lessons, teachers }) => {
                    ...
                    {lessons.map(lesson => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <ArrowRight className="text-slate-300 group-hover:text-indigo-500 transition-transform rtl:group-hover:-translate-x-1 ltr:group-hover:translate-x-1 shrink-0" />
                            </div>
                        );
                    })}
                </div>
