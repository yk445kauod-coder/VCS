...
import { Upload, Sparkles, AlertCircle, Search, ArrowRight, Globe } from 'lucide-react';
...
const LessonCreator: React.FC<Props> = ({ teachers, userRole, ownerId, schoolId }) => {
